  ...
  try {
    ...
    if (type === "event") {
      ...
      if (!data) {
        ...
        return { 
          vendorUserId: latestEvent?.userId || null, 
          serviceName: latestEvent?.name || "Event" 
        };
      }
    ...
    if (type === "hotel") {
      ...
      if (!data) {
        ...
        return { 
          vendorUserId: latestHotel?.userId || null, 
          serviceName: latestHotel?.name || "Hotel" 
        };
      }
    ...
    if (!data) {
      ...
      return { 
        vendorUserId: latestCafe?.userId || null, 
        serviceName: latestCafe?.name || "Cafe/Restoran" 
      };
    }
